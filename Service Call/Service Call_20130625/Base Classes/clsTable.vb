...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OADM" Or strTab = "OSCL" Or strTab = "INV1" Or strTab = "OWTR") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            'AddFields("OSCL", "Z_RecType", "Recurring Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 1)
            addField("OSCL", "Z_RecType", "Recurrence", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_Address, "D,W,M,Q,4M,S,Y,2Y,N", "Daily,Weekly,Monthly,Quarterly,4Months,Semi-Annualy,Yearly,2-Years,None", "N")
            addField("OSCL", "Z_IsDuplicate", "Duplicated", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            addField("OSCS", "Z_Status", "Status", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
