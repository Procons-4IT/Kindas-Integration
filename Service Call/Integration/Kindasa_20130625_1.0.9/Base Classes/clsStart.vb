Public Class clsStart
    ...
    Shared Sub Main()
        ...
        Try
            ...
            oMenuItem = oApplication.SBO_Application.Menus.Item("Z_mnu_JM001")
            oMenuItem.Image = Application.StartupPath & "\Inv.bmp"
            oApplication.Utilities.Message("Integration Addon Connected successfully", SAPbouiCOM.BoStatusBarMessageType.smt_Success)
