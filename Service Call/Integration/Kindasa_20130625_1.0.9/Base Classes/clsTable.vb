...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OADM" Or strTab = "OITT" Or strTab = "OITM" Or strTab = "INV1" Or strTab = "RDR1" Or strTab = "OINV" Or strTab = "OCRD" Or strTab = "ORCT") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddTables("Z_INT_LOGIN", "Linked Server Login Details", SAPbobsCOM.BoUTBTableType.bott_NoObject)

            AddFields("Z_INT_LOGIN", "Z_SERVER", "Linked Server Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("Z_INT_LOGIN", "Z_SQLDB", "Linked Server database Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("Z_INT_LOGIN", "Z_SQLUID", "Linked Server User ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_INT_LOGIN", "Z_SQLPWD", "Linked Server Password", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_INT_LOGIN", "Z_LOCALSQLDB", "Local Sql database Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("Z_INT_LOGIN", "Z_LOCUID", "Local Server User ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)


            addField("OCRD", "Z_Type", "Customer Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "A,P,C", "Agent,prepaid,Credit", "A")
            AddFields("OCRD", "Z_CardCode", "Customer Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            addField("OINV", "Z_INVType", "Invoice Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "P,C", "prepaid,Credit", "C")
            AddFields("OINV", "Z_Agent", "Agent Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("OINV", "Z_InvSeqNo", "Invoice Sequence Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("INV1", "Z_Ref", "Reference", SAPbobsCOM.BoFieldTypes.db_Alpha, , 254)
            AddFields("INV1", "Z_TrnsDate", "Transaction Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("ORCT", "Z_PreSeqNo", "Incoming Payment Sequence No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            addField("ORCT", "Z_PreType", "Payment Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Q,C", "Check,Cash", "C")


            oApplication.Utilities.Message("Integration Add-On-Initializing Database...", SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
